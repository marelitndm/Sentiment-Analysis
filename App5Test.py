        ...
        if json_response:
            try:
                ...
                data_to_insert = [
                    ...
                    parsed_json.get("Sentiment Summary Planning Team 6 Header", ""),
                    parsed_json.get("Sentiment Summary Team 6 Text", ""),
                    parsed_json.get("Sentiment Recommendation Team 6 Text", ""),
                    parsed_json.get("Sentiment Summary Planning Team 7 Header", ""),
                    parsed_json.get("Sentiment Summary Team 7 Text", ""),
                    parsed_json.get("Sentiment Recommendation Team 7 Text", ""),
                    parsed_json.get("Sentiment Summary Planning Team 8 Header", ""),
                    parsed_json.get("Sentiment Summary Team 8 Text", ""),
                    parsed_json.get("Sentiment Recommendation Team 8 Text", ""),
                    parsed_json.get("Sentiment Summary Planning Team 9 Header", ""),
                    parsed_json.get("Sentiment Summary Team 9 Text", ""),
                    parsed_json.get("Sentiment Recommendation Team 9 Text", ""),
                    parsed_json.get("Sentiment Summary Planning Team 10 Header", ""),
                    parsed_json.get("Sentiment Summary Team 10 Text", ""),
                    parsed_json.get("Sentiment Recommendation Team 10 Text", ""),
                    parsed_json.get("Sentiment Summary Planning Team 11 Header", ""),
                    parsed_json.get("Sentiment Summary Team 11 Text", ""),
                    parsed_json.get("Sentiment Recommendation Team 11 Text", ""),
                    parsed_json.get("Sentiment Summary Planning Team 12 Header", ""),
                    parsed_json.get("Sentiment Summary Team 12 Text", ""),
                    parsed_json.get("Sentiment Recommendation Team 12 Text", ""),
